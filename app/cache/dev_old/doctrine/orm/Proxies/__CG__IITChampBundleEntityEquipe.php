...
class Equipe extends \IIT\ChampBundle\Entity\Equipe implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'IIT\\ChampBundle\\Entity\\Equipe' . "\0" . 'designation', '' . "\0" . 'IIT\\ChampBundle\\Entity\\Equipe' . "\0" . 'adresselocal', '' . "\0" . 'IIT\\ChampBundle\\Entity\\Equipe' . "\0" . 'typeequipe', '' . "\0" . 'IIT\\ChampBundle\\Entity\\Equipe' . "\0" . 'id');
        }
