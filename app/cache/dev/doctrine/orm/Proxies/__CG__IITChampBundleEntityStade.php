 ...
 */
class Stade extends \IIT\ChampBundle\Entity\Stade implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'IIT\\ChampBundle\\Entity\\Stade' . "\0" . 'designation', '' . "\0" . 'IIT\\ChampBundle\\Entity\\Stade' . "\0" . 'pays', '' . "\0" . 'IIT\\ChampBundle\\Entity\\Stade' . "\0" . 'adresse', '' . "\0" . 'IIT\\ChampBundle\\Entity\\Stade' . "\0" . 'id'];
        }
