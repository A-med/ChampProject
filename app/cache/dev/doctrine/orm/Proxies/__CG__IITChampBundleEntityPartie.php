...
namespace Proxies\__CG__\IIT\ChampBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Partie extends \IIT\ChampBundle\Entity\Partie implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'IIT\\ChampBundle\\Entity\\Partie' . "\0" . 'id', '' . "\0" . 'IIT\\ChampBundle\\Entity\\Partie' . "\0" . 'idequipe2', '' . "\0" . 'IIT\\ChampBundle\\Entity\\Partie' . "\0" . 'idstade', '' . "\0" . 'IIT\\ChampBundle\\Entity\\Partie' . "\0" . 'idcompetition', '' . "\0" . 'IIT\\ChampBundle\\Entity\\Partie' . "\0" . 'iddate', '' . "\0" . 'IIT\\ChampBundle\\Entity\\Partie' . "\0" . 'idequipe1', '' . "\0" . 'IIT\\ChampBundle\\Entity\\Partie' . "\0" . 'descr'];
        }
    ...
    public function setIdcompetition(\IIT\ChampBundle\Entity\Competition $idcompetition = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdcompetition', [$idcompetition]);

        return parent::setIdcompetition($idcompetition);
    }
    ...
    public function getIdcompetition()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdcompetition', []);

        return parent::getIdcompetition();
    }
