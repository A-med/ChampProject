...
use IIT\ChampBundle\Entity\Date;
use IIT\ChampBundle\Form\DateType;
...
class DateController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('IITChampBundle:Date')->findAll();
     ...
     * @Method("POST")
     * @Template("IITChampBundle:Date:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('IITChampBundle:Date')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("IITChampBundle:Date:edit.html.twig")
     */
