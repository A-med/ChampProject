...
use IIT\ChampBundle\Entity\Equipe;
use IIT\ChampBundle\Form\EquipeType;
...
class EquipeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('IITChampBundle:Equipe')->findAll();
     ...
     * @Method("POST")
     * @Template("IITChampBundle:Equipe:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('IITChampBundle:Equipe')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("IITChampBundle:Equipe:edit.html.twig")
     */
