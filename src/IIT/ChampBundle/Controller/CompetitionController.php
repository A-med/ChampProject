...
namespace IIT\ChampBundle\Controller;
...
use IIT\ChampBundle\Entity\Competition;
use IIT\ChampBundle\Form\CompetitionType;
...
class CompetitionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('IITChampBundle:Competition')->findAll();
     ...
     * @Method("POST")
     * @Template("IITChampBundle:Competition:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('IITChampBundle:Competition')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("IITChampBundle:Competition:edit.html.twig")
     */
