...
use IIT\ChampBundle\Entity\Resultat;
use IIT\ChampBundle\Form\ResultatType;
...
class ResultatController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('IITChampBundle:Resultat')->findAll();
     ...
     * @Method("POST")
     * @Template("IITChampBundle:Resultat:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('IITChampBundle:Resultat')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("IITChampBundle:Resultat:edit.html.twig")
     */
