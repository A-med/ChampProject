...
use IIT\ChampBundle\Entity\Partie;
use IIT\ChampBundle\Form\PartieType;
...
class PartieController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('IITChampBundle:Partie')->findAll();
     ...
     * @Method("POST")
     * @Template("IITChampBundle:Partie:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('IITChampBundle:Partie')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("IITChampBundle:Partie:edit.html.twig")
     */
