...
use IIT\ChampBundle\Entity\Calendrier;
use IIT\ChampBundle\Form\CalendrierType;
...
class CalendrierController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('IITChampBundle:Calendrier')->findAll();
     ...
     * @Method("POST")
     * @Template("IITChampBundle:Calendrier:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('IITChampBundle:Calendrier')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("IITChampBundle:Calendrier:edit.html.twig")
     */
