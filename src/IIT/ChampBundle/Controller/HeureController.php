...
use IIT\ChampBundle\Entity\Heure;
use IIT\ChampBundle\Form\HeureType;
...
class HeureController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('IITChampBundle:Heure')->findAll();
     ...
     * @Method("POST")
     * @Template("IITChampBundle:Heure:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('IITChampBundle:Heure')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("IITChampBundle:Heure:edit.html.twig")
     */
