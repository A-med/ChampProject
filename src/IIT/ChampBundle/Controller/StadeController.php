...
use IIT\ChampBundle\Entity\Stade;
use IIT\ChampBundle\Form\StadeType;
...
class StadeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('IITChampBundle:Stade')->findAll();
     ...
     * @Method("POST")
     * @Template("IITChampBundle:Stade:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('IITChampBundle:Stade')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("IITChampBundle:Stade:edit.html.twig")
     */
